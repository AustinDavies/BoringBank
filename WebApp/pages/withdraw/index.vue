                ...
                <v-layout style="margin-top:5rem;"
                  ...
                  <v-flex xs12
                    ...
                    <v-text-field autofocus
                                  ...
                                  v-model="amount"
                                  placeholder="$50.00"
                                  hint="Enter an amount to withdraw"
              ...
              <v-layout fill-height
                ...
                <v-flex shrink>
                  <v-card-text>
                    ...
                    <v-btn @click="onWithdrawalClicked"
                           dark
                           rounded
                           color="tertiary">Make Withdrawal</v-btn>
          ...
          <v-layout justify-center
            ...
            <v-flex xs12>
              <v-btn block
                     ...
                     color="secondary"
                     text>Make Another Withdrawal</v-btn>
            </v-flex>
          </v-layout>
        </v-card-text>
      </v-card>
